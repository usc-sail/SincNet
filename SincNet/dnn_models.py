...
class SincWrapper(nn.Module):
    def __init__(self, DNN2_options, DNN1_options, CNN_options):
        ...
        self.fc_drop=DNN2_options['fc_drop']
        self.fc_use_batchnorm=DNN2_options['fc_use_batchnorm']
        self.fc_use_laynorm=DNN2_options['fc_use_laynorm']
        self.fc_use_laynorm_inp=DNN2_options['fc_use_laynorm_inp']
        self.fc_use_batchnorm_inp=DNN2_options['fc_use_batchnorm_inp']
        self.fc_act=DNN2_options['fc_act']
...
class MLP(nn.Module):
    def __init__(self, DNN_options, CNN_options):
        ...
        self.fc_use_batchnorm=DNN_options['fc_use_batchnorm']
        self.fc_use_laynorm=DNN_options['fc_use_laynorm']
        self.fc_use_laynorm_inp=DNN_options['fc_use_laynorm_inp']
        self.fc_use_batchnorm_inp=DNN_options['fc_use_batchnorm_inp']
        self.fc_act=DNN_options['fc_act']
